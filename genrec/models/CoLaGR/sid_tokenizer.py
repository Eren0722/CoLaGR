...
class SemanticIDTokenizer(AbstractTokenizer):
    """
    ...
    def _init_tokenizer(self, dataset: AbstractDataset):
        ...
        if not os.path.exists(sem_ids_path):
            ...
            if vq_method == 'opq':
                ...
                raise ValueError(
                    f'Unknown vq_method: {vq_method}. Supported methods: '
                    'opq, rqkmeans, rqvae, or prebuilt non-PSID methods such as coba.'
                )
