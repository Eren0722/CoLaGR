...
def export_split_candidates(pipeline, split, output_path):
...
def parse_args():
    ...
    parser.add_argument('--coreason_train_path', default=None)
    parser.add_argument('--coreason_mode', default='future_value')
    parser.add_argument('--lambda_reason', type=float, default=1.0)
    ...
    parser.add_argument('--use_coreason', default=False)
    ...
    parser.add_argument(
        '--copref_reasoning_mode', choices=('per_level', 'one_shot'), default='per_level'
    )
...
def main():
    ...
    export_split_candidates(pipeline, split, output)
