...
FULL_PREFIX=${FULL_PREFIX:-cds_sa_teacher}
WO_USER_PREFIX=${WO_USER_PREFIX:-cds_wo_usercl_teacher}
WO_ITEM_PREFIX=${WO_ITEM_PREFIX:-cds_wo_itemcl_teacher}

FULL_SI_SAVE=${FULL_SI_SAVE:-cds_si}
PURE_SI_SAVE=${PURE_SI_SAVE:-cds_pure_sasrec_si}
WO_USER_SI_SAVE=${WO_USER_SI_SAVE:-cds_wo_usercl_si}
WO_ITEM_SI_SAVE=${WO_ITEM_SI_SAVE:-cds_wo_itemcl_si}
WO_MATCH_SI_SAVE=${WO_MATCH_SI_SAVE:-cds_wo_match_si}
...
prepare_assets() {
  ...
  PYTHONPATH=$(pwd) CUDA_VISIBLE_DEVICES=${TRAIN_DEVICE} python -m SA.generate_assets \
    --dataset ${DATASET} \
    --data_root ./SeqRec \
