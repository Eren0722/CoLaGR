...
FULL_PREFIX=${FULL_PREFIX:-movies_sa_teacher}
WO_USER_PREFIX=${WO_USER_PREFIX:-movies_wo_usercl_teacher}
WO_ITEM_PREFIX=${WO_ITEM_PREFIX:-movies_wo_itemcl_teacher}

FULL_SI_SAVE=${FULL_SI_SAVE:-movies_si_l40s}
PURE_SI_SAVE=${PURE_SI_SAVE:-movies_pure_sasrec_si_l40s}
WO_USER_SI_SAVE=${WO_USER_SI_SAVE:-movies_wo_usercl_si_l40s}
WO_ITEM_SI_SAVE=${WO_ITEM_SI_SAVE:-movies_wo_itemcl_si_l40s}
WO_MATCH_SI_SAVE=${WO_MATCH_SI_SAVE:-movies_wo_match_si_l40s}
...
echo "===== Movies single-L40 ablation completed ====="
