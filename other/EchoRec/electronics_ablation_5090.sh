...
FULL_SI_SAVE=${FULL_SI_SAVE:-electronics_si_5090}
PURE_SI_SAVE=${PURE_SI_SAVE:-electronics_pure_sasrec_si_5090}
WO_USER_SI_SAVE=${WO_USER_SI_SAVE:-electronics_wo_usercl_si_5090}
WO_ITEM_SI_SAVE=${WO_ITEM_SI_SAVE:-electronics_wo_itemcl_si_5090}
WO_MATCH_SI_SAVE=${WO_MATCH_SI_SAVE:-electronics_wo_match_si_5090}
