...
FULL_SI_SAVE=${FULL_SI_SAVE:-scientific_si_l40s}
PURE_SI_SAVE=${PURE_SI_SAVE:-scientific_pure_sasrec_si_l40s}
WO_USER_SI_SAVE=${WO_USER_SI_SAVE:-scientific_wo_usercl_si_l40s}
WO_ITEM_SI_SAVE=${WO_ITEM_SI_SAVE:-scientific_wo_itemcl_si_l40s}
WO_MATCH_SI_SAVE=${WO_MATCH_SI_SAVE:-scientific_wo_match_si_l40s}
...
echo "===== Scientific single-L40 ablation completed ====="
