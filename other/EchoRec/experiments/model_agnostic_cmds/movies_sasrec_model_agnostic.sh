...
BACKBONE_LEARNING_RATE="${BACKBONE_LEARNING_RATE:-1e-4}"
MAXLEN="${MAXLEN:-128}"
...
ALPHA="${ALPHA:-0.1}"
BETA="${BETA:-0.1}"
MLM_PROB="${MLM_PROB:-0.2}"
TEMPERATURE="${TEMPERATURE:-1.0}"
REPR_MODE="${REPR_MODE:-mean}"

FULL_PREFIX="${FULL_PREFIX:-movies_sasrec_sacp_adapt_ce}"
WO_PREFIX="${WO_PREFIX:-movies_sasrec_sacp_adapt_wo_sacp}"
