...
def preprocess_raw_5core(fname):
    ...
    use_key = random.sample(list(User.keys()), int(sample_size*sample_ratio))#Movies 0.05 Industrial 鞚€ 氚旊 靷毄 Electronics 0.05 Books 0.075 Sport 0.1 Beauty 0.075 Software 0.33
