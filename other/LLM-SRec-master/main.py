...
if __name__ == "__main__":
    ...
    parser.add_argument("--llm_path", type=str, default='', help='optional local path for the LLM/tokenizer')
    ...
    #这个参数 --maxlen 是 “最大序列长度” (Maximum Sequence Length)。
    #它定义了模型在处理用户历史行为时，最多回溯多少个最近的交互记录。
    #【致命陷阱】必须与 SASRec 保持一致！
